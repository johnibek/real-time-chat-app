...
urlpatterns = [
    ...
    path("chat/messages/<int:message_id>/delete", views.delete_message, name='delete-message'),
    path("chat/messages/<int:message_id>/edit", views.edit_message, name='edit-message'),
