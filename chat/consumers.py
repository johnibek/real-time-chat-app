...
"""  Without async_to_sync(), the code should look like this
...
class ChatroomConsumer(WebsocketConsumer):
    def connect(self):
        ...
        # This has been done asynchronously. So we should wrap this by async_to_sync() function
        async_to_sync(self.channel_layer.group_add)(
            self.chatroom_name, self.channel_name  # self.channel_name will be generated by the server automatically
        )
